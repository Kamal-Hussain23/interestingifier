...
2. **The Vibrant Transformation** — Take the transcript and rewrite it as an over-the-top story via Gemini generative text (`gemini-3.1-flash-lite`), then persist the story to SQLite (the transcript is already saved in feature 1).
